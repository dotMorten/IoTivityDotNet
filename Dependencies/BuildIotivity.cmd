...
CALL scons TARGET_OS=windows TARGET_ARCH=x86 RELEASE=1 WITH_RA=0 TARGET_TRANSPORT=IP SECURED=0 WITH_TCP=0 BUILD_SAMPLE=ON LOGGING=OFF TEST=0 resource/csdk
MD ..\..\Libs\octbstack\Windows\x86\
COPY out\windows\x86\release\resource\csdk\octbstack.dll ..\..\Libs\octbstack\Windows\x86\ /Y

ECHO ********************************** BUILDING x64 Release **********************************
CALL scons TARGET_OS=windows TARGET_ARCH=amd64 RELEASE=1 WITH_RA=0 TARGET_TRANSPORT=IP SECURED=0 WITH_TCP=0 BUILD_SAMPLE=ON LOGGING=OFF TEST=0 resource/csdk
...
CALL scons TARGET_OS=windows TARGET_ARCH=x86 RELEASE=0 WITH_RA=0 TARGET_TRANSPORT=IP SECURED=0 WITH_TCP=0 BUILD_SAMPLE=ON LOGGING=OFF TEST=0 resource/csdk
...
CALL scons TARGET_OS=windows TARGET_ARCH=amd64 RELEASE=0 WITH_RA=0 TARGET_TRANSPORT=IP SECURED=0 WITH_TCP=0 BUILD_SAMPLE=ON LOGGING=OFF TEST=0 resource/csdk
...
REM CALL scons TARGET_OS=windows TARGET_ARCH=arm RELEASE=0 WITH_RA=0 TARGET_TRANSPORT=IP SECURED=0 WITH_TCP=0 BUILD_SAMPLE=ON LOGGING=OFF TEST=0 resource/csdk
REM CALL scons TARGET_OS=windows TARGET_ARCH=arm RELEASE=1 WITH_RA=0 TARGET_TRANSPORT=IP SECURED=0 WITH_TCP=0 BUILD_SAMPLE=ON LOGGING=OFF TEST=0 resource/csdk
PAUSE